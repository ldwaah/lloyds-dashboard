# Jayden O'Brien - Email Evidence Report
...
- HxStore.hxd (`data/emails-extracted/jayden-obrien.txt`)
- Outlook Web: name variants searched

## Email evidence

### Thread 1: Re: Jayden O Brien - Year 10 4 week placement

| Field | Detail |
|-------|--------|
| Subject | `Re: Jayden O Brien - Year 10 4 week plac` / `Re: Jayden O Brien - Year 10 4 week place` |
| Dates (from headers) | 7 May 2026 at 09:06:11 BST; 07 May 2026 14:09 |
| Senders / participants | Lorelle Gavillet; BOULTON, C (BOU) @ jori...dson.org.uk; HOWE, A (HOW); Eugene Dwaah; Admin Support |
| Source | HxStore cache |

**Quotes / snippets:**

- `Please can you update me on Jayden O Brien's progress and let( know when the 4 week respite placement is up -I have a review meeting pencilled in my diary for 8th May at 8.45am butV not confirmed this with mum`
- `Please can you confirm that Jayden O Brien has returned following his work experience placement?? I never heard from mum as to where he went?`
- Subject explicitly references **Year 10** and **4 week** placement.

**Topics:** placement progress, school liaison (JRCS), work experience return, review meeting

---

### Other mentions

- Name appears in student list context: `Jayden O'Brie` alongside Harrison Jones, Joshua Lang (batch / portal list fragment in cache)
